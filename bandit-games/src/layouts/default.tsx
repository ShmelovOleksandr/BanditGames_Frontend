...
export default function DefaultLayout({
    ...
    return (
        <div className="relative flex flex-col h-screen">
            ...
            <footer className="flex flex-col w-full h-fit bg-[#310150] text-[#e4d4f4] px-14 py-14">
                <div className="flex flex-row">
                    <div className="flex flex-col gap-2 justify-center w-[35%] w-[35%]">
                        ...
                        <div className="grid grid-cols-3 gap-15 w-fit p-4"><a href="#">
                    ...
                    <div className="flex flex-row w-[65%] justify-end gap-16 text-nowrap">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <form className="flex items-center">
                                ...
                                <button type="submit"
                                        className="bg-[#7e22ce] text-[#ffffff] font-semibold py-3 px-6 rounded-r-lg transition-colors duration-300">Subscribe
                                </button>
                            </form>
                        </div>
                    </div>
